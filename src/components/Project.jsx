  ...
  return (
    <div className="bg-gradient-to-tl from-zinc-800 via-red-600 to-stone-800">
      <section className="xs:h-auto xs:py-52 lg:py-0 lg:h-screen flex justify-center items-center">
        ...
        >
          <button className="bg-gradient-to-b from-blue-700 via-zinc-800 to-zinc-800 rounded-2xl xs:py-16 xs:px-0 lg:px-24 lg:py-32 hover:scale-105 transition-all font-bold">
